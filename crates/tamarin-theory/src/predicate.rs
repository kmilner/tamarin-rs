...
//! [`LNFormula`]: the expansion is what strips the `Pred` sugar.
//! `predicate_expand.rs` holds the same rewrite over parser-AST formulas for
//! the passes that still run before elaboration.
